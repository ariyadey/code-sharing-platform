...
public interface CodeProjectorApi {
    ...
    @Value("#{target.secret ? 0 : @dateTime.getDurationLeftInSeconds(target.uploadDateTime)}")
    Integer getTime();
    ...
    static CodeProjectorApi fromCode(Code code) {
        return new CodeProjectorApi() {
            ...
            public Integer getTime() {
                return code.isSecret() ? 0 : DateTime.getDurationLeftInSeconds(code.getUploadDateTime());
            }
